        ...
        <div className = "flex justify-start">
            <div className = "bg-white min-h-screen w-1/2 flex justify-center items-center">
                <form className="w-1/2">
                    ...
                    <div className = "">
                        <button className = "mt-4 mb-3 w-full bg-black hover:bg-stone-800 text-white py-2 rounded-md transition-duration-100">Login Sekarang</button>                        
                    </div>
                    <div className="flex justify-between">
								...
								<span className="text-sm text-black hover:underline cursor-pointer">Lupa password?</span>
							</div>
                </form>
            </div>
        </div>
